 ...
 * 普通刺激级别
 */
public class OrdinaryStimulationImpl implements IGetEquation {
    @Override
    public Set<FormulaData> equations() {
        ...
        do{
            ...
            formulaData.setDescription(GradeEnum.ORDINARY_STIMULATION.getDescription());
