 ...
 * 进阶噩梦级
 */
public class AdvancedNightmareImpl implements IGetEquation {
    @Override
    public Set<FormulaData> equations() {
        Set<FormulaData> formulaDataSet = new HashSet<>();
        do{
            //抽签获取等式
            int[] numbers = {0,2,4,5,6,7,8,9};
            ...
            formulaData.setDescription(GradeEnum.ADVANCED_NIGHTMARE.getDescription());
